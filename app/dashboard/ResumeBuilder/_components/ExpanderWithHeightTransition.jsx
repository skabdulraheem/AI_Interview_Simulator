 ...
 *
 */
export var ExpanderWithHeightTransition = function (_a) {
    var expanded = _a.expanded, children = _a.children;
    return (<div className={"grid overflow-hidden transition-all duration-300 ".concat(expanded ? "visible" : "invisible")} style={{ gridTemplateRows: expanded ? "1fr" : "0fr" }}>
