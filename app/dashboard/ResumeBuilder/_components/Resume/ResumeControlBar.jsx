...
import { useSetDefaultScale } from "../../_components/Resume/hooks";
...
const ResumeControlBar = ({ scale, setScale, documentSize, document, fileName }) => {
  ...
  // Safeguard: Ensure `document` is valid before calling `usePDF`
  useEffect(() => {
    if (!document) {
      console.error("Document is not provided or invalid:", document);
    }
  }, [document]);
